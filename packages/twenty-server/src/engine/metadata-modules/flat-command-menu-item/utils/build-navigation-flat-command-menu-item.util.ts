...
// The stored label is the source message translators see, with the target
// object's label left as a placeholder the server fills once it has resolved
// that object for the reader's locale.
